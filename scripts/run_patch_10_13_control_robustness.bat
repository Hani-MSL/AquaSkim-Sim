...
echo ========================================================================
echo AquaSkim-Sim - Patch 10.13 Current-aware Control Robustness Validation
echo ========================================================================
echo Gate order: YAML parse, import audit, syntax, full tests, then control evidence media.
...
echo ========================================================================
echo AquaSkim-Sim - Full pytest suite before control-robustness media
echo ========================================================================
python -m pytest -q
if errorlevel 1 exit /b 1

echo ========================================================================
echo AquaSkim-Sim - Reference evidence renewal after policy-loader recovery
echo ========================================================================
echo Refreshing the fixed Reference Mission Fidelity and Operating Envelope artifacts from current source.
...
echo ========================================================================
echo AquaSkim-Sim - Fixed current-aware control robustness and media build
echo ========================================================================
...
echo ========================================================================
echo AquaSkim-Sim - Patch 10.13 Recorded Control-robustness Run
echo ========================================================================
echo Status       : PASS
